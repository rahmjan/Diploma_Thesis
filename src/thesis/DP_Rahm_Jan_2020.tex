...
\end{lstlisting}
Or you can copy the whole folder "src/esp" form this diploma thesis source to your "\$PATH_TO_ESP/esp".
...
To load application to ESP32-LyraT, one must first build the project. For example, copy the project "\$PATH_TO_ESP/esp/esp-idf/examples/get-started/hello_world" to "\$PATH_TO_ESP/esp/hello_world". In this folder it is possible to build it:
\begin{lstlisting}[frame=single]
idf.py -n build
\end{lstlisting}
