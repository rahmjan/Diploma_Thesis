...
For measurement I selected the reference signature schemes. Dividing by security levels there are:
...
In this section is comparison of size of signature for different settings of algorithms. Must be noted that the size of signature of ESP32 implementations are the same as PC implementation. I just noted them from the ESP32 implemetations.
\begin{figure}[H]
\centering
...
\caption{Memoru requiment comparison with conventional algorithms}
\label{mem-all}
\end{figure}
